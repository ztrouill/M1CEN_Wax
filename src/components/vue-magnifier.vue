<template>
    <div>
        <div class="vue-magnifier-container">
            <slot></slot>
            <span ref="magnificationElement" class="preview magnifyEl" v-bind:style="{backgroundImage:'url(' + src + ')'}">
            <span
                ref="glass"
...
export default {
    ...
    methods: {
        ...
        getBounds() {
            let el = document.querySelector(".magnifyEl");//this.$refs.magnificationElement;
